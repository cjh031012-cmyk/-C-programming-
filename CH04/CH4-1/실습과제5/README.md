...
- 반복문을 통해 인덱스 0~2인 t객체배열을 cout을 통해 하나하나씩 삼각형의 면적을 알려주는 메시지 출력 (포인터 표현 p = 인덱스 0인 배열, 포인터 표현 p+1은 인덱스가 1인 배열, 포인터 표현p+2는 인덱스가 2인 배열)
...
###실행결과
---
<img width="998" height="290" alt="image" src="https://github.com/user-attachments/assets/437148ae-5a86-4506-90ea-64d5325a2832" />
